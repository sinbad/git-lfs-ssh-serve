...
import (
	...
	contentaddressable "github.com/sinbad/git-lfs-ssh-serve/Godeps/_workspace/src/github.com/github/git-lfs/vendor/_nuts/github.com/technoweenie/go-contentaddressable"
)
